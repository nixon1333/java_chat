 ...
 * @author niXon
 */
public class aChatClientGUI {
    
    //globals
    private static aChatClient ChatClient;
...
//---------------------------------------------------------------------------
    ...
    public static void Connect()
    {
	    ...
	    //use a free port
            final int PORT = 1333;
	    //place your computer name as host
            final String HOST = "niXon-x64";
            Socket SOCK = new Socket(HOST,PORT);
            System.out.println("You connected to: " + HOST);
            
            ChatClient = new aChatClient(SOCK);
            
            //send Name to add online list
    ...
    public static void ConfigureMainWindow()
    {
        ...
        //String [] TestNames = {"Nixon","Nix","N","Sara"};
        ...
        L_LoggedInAs.setBounds(345, 0, 140, 15);
    ...
    public static void ACTION_B_ENTER()
    {
        if(!TF_UserNameBox.getText().equals(""))
        {
            ...
            aChatServer.CurrentUsers.add(UserName);
            MainWindow.setTitle(UserName + "'s chat box");
    ...
    public static void ACTION_B_HELP()
    {
        JOptionPane.showMessageDialog(null,
               "DONE by Md. Ashraful Islam Nixon c2013");
    }
}
